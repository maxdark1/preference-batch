...
class LoyaltyComplaintWeeklyMapperTest
{
	...
	void setUp()
	{
		...
		loyaltyCompliantDTO = new LoyaltyCompliantDTO(emailAddr, canPtcEffectiveDate, canPtcSourceId, emailStatus, canPtcFlag,
				firstName, lastName, languagePreference, earlyOptInDate, cndCompliantFlag, hdCaFlag, hdCaGardenClubFlag, hdCaProFlag,
