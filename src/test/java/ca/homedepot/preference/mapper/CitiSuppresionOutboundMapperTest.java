...
class CitiSuppresionOutboundMapperTest {
    ...
    ResultSet rs;
     ...
     String firstName = "firstName", middleInitial = "middleInitial", lastName = "lastName",
    emailAddr ="email@example.com", addrLine1 = "addrLine1", addrLine2 = "addrLine2", stateCd = "stateCd",
    postalCd = "postalCd", city = "city", phone = "1234567890", smsPhoneMobile = "3216549870", dmOptOut = "N",
    emailOptOut ="N", phoneOptOut="N", smsOptOut="N", businessName = "businessName";

     @BeforeEach
     void setup(){
         MockitoAnnotations.initMocks(this);

         citiSuppresionOutboundDTO = new CitiSuppresionOutboundDTO(firstName, middleInitial, lastName, addrLine1, addrLine2, city, stateCd, postalCd, emailAddr, phone, smsPhoneMobile, businessName, dmOptOut, emailOptOut, phoneOptOut, smsOptOut);
