...
class InternalFlexOutboundStep1MapperTest
{
	InternalFlexOutboundStep1Mapper internalFlexOutboundStep1Mapper;
	Faker faker;

	@BeforeEach
	void setUp()
	{
		internalFlexOutboundStep1Mapper = new InternalFlexOutboundStep1Mapper();
		faker = new Faker();
	}
	...
	void testMapRow() throws SQLException
	{
		...
		InternalFlexOutboundDTO result = internalFlexOutboundStep1Mapper.mapRow(rs, 0);
