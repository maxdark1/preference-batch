...
public class SalesforceExtractFileWriter extends FlatFileItemWriter<SalesforceExtractOutboundDTO>
{
    ...
    public DelimitedLineAggregator<SalesforceExtractOutboundDTO> getLineAggregator()
    {
        ...
        beanWrapperFieldExtractor.setNames(new String[]
                { "EmailAddress", "AsOfDate", "SourceId", "EmailStatus", "EmailPtc", "LanguagePreference", "EarliestOptInDate", "HdCanadaEmailCompliantFlag", "HdCanadaFlag", "GardenClubFlag", "NewMoverFlag", "ProFlag",
                        "PhonePtcFlag", "FirstName", "LastName", "PostalCode", "Province", "City", "PhoneNumber", "BusinessName", "BusinessType", "MoveDate", "DwellingType"
                });
