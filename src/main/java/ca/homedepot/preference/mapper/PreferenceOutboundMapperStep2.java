...
public class PreferenceOutboundMapperStep2 implements RowMapper<PreferenceOutboundDto>
{
	...
	public PreferenceOutboundDto mapRow(ResultSet rs, int i) throws SQLException
	{
		...
		outboundData
				.setEffective_date(rs.getDate("can_ptc_effective_date") /* != null ? rs.getDate("effective_date") : new Date(0) */);
		outboundData
				.setSource_id(rs.getBigDecimal("can_ptc_source_id") /* != null ? rs.getBigDecimal("source_id") : BigDecimal.ZERO */);
		outboundData
		...
		outboundData.setEmail_pref_garden_club(rs.getString("hd_ca_garden_club_flag")
