...
public class PreferenceOutboundMapperStep2 implements RowMapper<PreferenceOutboundDto>
{
	...
	public PreferenceOutboundDto mapRow(ResultSet rs, int i) throws SQLException
	{
		...
		outboundData.setEffectiveDate(rs.getDate("can_ptc_effective_date") /*!= null ? rs.getDate("effective_date") : new Date(0)*/);
		outboundData.setSourceId(rs.getBigDecimal("can_ptc_source_id") /*!= null ? rs.getBigDecimal("source_id") : BigDecimal.ZERO */);
		outboundData.setEmailStatus(rs.getBigDecimal("email_status") /*!= null ? rs.getBigDecimal("email_status") : BigDecimal.ZERO*/);
		outboundData.setEmailPermission(rs.getString("can_ptc_flag").charAt(0) /*!= null ? rs.getString("email_permission").charAt(0) : 'N'*/);
		...
		outboundData.setEmailPrefHdCa(rs.getString("hd_ca_flag").charAt(0) /*!= null ? rs.getString("email_pref_hd_ca").charAt(0) : 'N'*/);
		outboundData.setEmailPrefGardenClub(rs.getString("hd_ca_garden_club_flag").charAt(0) /*!= null ? rs.getString("email_pref_garden_club").charAt(0) : 'N'*/);
		outboundData.setEmailPrefPro(rs.getString("hd_ca_pro_flag").charAt(0) /*!= null ? rs.getString("email_pref_pro").charAt(0) : 'N'*/);
		...
		outboundData.setDnclSuppresion(rs.getString("dncl_suppression_flag").charAt(0) /*!= null ? rs.getString("dncl_suppresion").charAt(0) : 'N'*/);
