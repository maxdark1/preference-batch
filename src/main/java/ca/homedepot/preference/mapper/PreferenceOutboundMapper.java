...
public class PreferenceOutboundMapper implements RowMapper<PreferenceOutboundDto>
{
	...
	public PreferenceOutboundDto mapRow(ResultSet rs, int i) throws SQLException
	{
		...
		outboundData.setEmail_permission(rs.getString("email_permission").charAt(0) /*!= null ? rs.getString("email_permission").charAt(0) : 'N'*/);
		...
		outboundData.setEmail_pref_hd_ca(rs.getString("email_pref_hd_ca").charAt(0) /*!= null ? rs.getString("email_pref_hd_ca").charAt(0) : 'N'*/);
		outboundData.setEmail_pref_garden_club(rs.getString("email_pref_garden_club").charAt(0) /*!= null ? rs.getString("email_pref_garden_club").charAt(0) : 'N'*/);
		outboundData.setEmail_pref_pro(rs.getString("email_pref_pro").charAt(0) /*!= null ? rs.getString("email_pref_pro").charAt(0) : 'N'*/);
		...
		outboundData.setDncl_suppresion(rs.getString("dncl_suppresion").charAt(0) /*!= null ? rs.getString("dncl_suppresion").charAt(0) : 'N'*/);
