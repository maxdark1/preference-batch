...
public class PreferenceOutboundMapper implements RowMapper<PreferenceOutboundDto>
{
	...
	public PreferenceOutboundDto mapRow(ResultSet rs, int i) throws SQLException
	{
		...
		outboundData
				.setEmail_status(rs.getBigDecimal("email_status") /* != null ? rs.getBigDecimal("email_status") : BigDecimal.ZERO */);
		outboundData.setEmail_permission(
		...
		outboundData
				.setEarly_opt_in_date(rs.getDate("early_opt_in_date") /* != null ? rs.getDate("early_opt_in_date") : new Date(0) */);
		outboundData.setCnd_compliant_flag(
				rs.getString("cnd_compliant_flag").charAt(0) /* != null ? rs.getString("cnd_compliant_flag").charAt(0) : 'N' */);
		outboundData.setEmail_pref_hd_ca(
				rs.getString("email_pref_hd_ca").charAt(0) /* != null ? rs.getString("email_pref_hd_ca").charAt(0) : 'N' */);
		outboundData.setEmail_pref_garden_club(rs.getString("email_pref_garden_club")
				.charAt(0) /* != null ? rs.getString("email_pref_garden_club").charAt(0) : 'N' */);
		outboundData.setEmail_pref_pro(
		...
		outboundData.setHd_ca_pro_src_id(
