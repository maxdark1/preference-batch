...
public class PreferenceOutboundMapper implements RowMapper<PreferenceOutboundDto>
{
	...
	public PreferenceOutboundDto mapRow(ResultSet rs, int i) throws SQLException
	{
		...
		outboundData.setEffective_date(rs.getDate("effective_date") != null ? rs.getDate("effective_date") : new Date(0));
		outboundData.setSource_id(rs.getBigDecimal("source_id") != null ? rs.getBigDecimal("source_id") : BigDecimal.ZERO );
		outboundData.setEmail_status(rs.getBigDecimal("email_status") != null ? rs.getBigDecimal("email_status") : BigDecimal.ZERO);
		outboundData.setEmail_permission(rs.getString("email_permission") != null ? rs.getString("email_permission").charAt(0) : 'N');
		...
		outboundData.setCnd_compliant_flag(rs.getString("cnd_compliant_flag") != null ? rs.getString("cnd_compliant_flag").charAt(0) : 'N');
		outboundData.setEmail_pref_hd_ca(rs.getString("email_pref_hd_ca") != null ? rs.getString("email_pref_hd_ca").charAt(0) : 'N');
		outboundData.setEmail_pref_garden_club(rs.getString("email_pref_garden_club") != null ? rs.getString("email_pref_garden_club").charAt(0) : 'N');
		outboundData.setEmail_pref_pro(rs.getString("email_pref_pro") != null ? rs.getString("email_pref_pro").charAt(0) : 'N');
		outboundData.setPostal_code(rs.getString("src_postal_code")!= null ? rs.getString("src_postal_code") : "");
		outboundData.setCustomer_nbr(rs.getString("customer_nbr")!= null ? rs.getString("customer_nbr") : "");
		outboundData.setPhone_ptc_flag(rs.getString("phone_ptc_flag") != null ? rs.getString("phone_ptc_flag").charAt(0) : 'N');
		outboundData.setDncl_suppresion(rs.getString("dncl_suppresion")!= null ? rs.getString("dncl_suppresion").charAt(0) : 'N');
