...
public class OutboundSqlQueriesConstants
{
	...
	public static final String SQL_GET_CRM_OUTBOUND = "WITH\n"
			...
			+ "                , (select old_id from hdpc_master_id_rel where pcam_id = email.source_type)  source_id\n"
			...
			+ "                                                , (select old_id from hdpc_master_id_rel where pcam_id = MAX(CASE WHEN mast.value_val = 'Pro' THEN pref.source_type else 0 end)) hd_ca_pro_src_id\n"
