...
public final class SqlQueriesConstants
{
	 ...
	 */
	public static final String SQL_INSERT_FILE_INBOUND_STG_ERROR = "INSERT INTO public.hdpc_file_inbound_stg_error(\n"
	 ...
	 */
	public static final String SQL_INSERT_FILE_INBOUND_STG_REGISTRATION = "INSERT INTO public.hdpc_file_inbound_stg(\n"
	...
	public static final String SQL_PURGE_SUCCESS_STG_TABLE = "DELETE FROM public.hdpc_file_inbound_stg WHERE status = 'S';";
