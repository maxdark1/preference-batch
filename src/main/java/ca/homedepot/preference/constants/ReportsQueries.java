...
public class ReportsQueries
{
	...
	public static String DAILY_COUNT_REPORT_EMAIL_PREFERENCES_QUERY = "\n"
			...
			+ "\t\tAND (CAST(inserted_date as DATE)  >= (SELECT CAST(MAX(inserted_date) AS DATE) FROM hdpc_email_notification WHERE source_name != 'SFMC' AND type_file like '%inbound%') OR (inserted_date = \n"
